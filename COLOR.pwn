...
#define COLOR_PURPLE4 		0x5A00FFFF
#define COLOR_BAR	    	0x333333FF// 2a2a2a
#define COLOR_PURPLE2 		0xA02BFCFF //agak light
#define COLOR_INV 			0xEFD7FFFF
#define COLOR_INV2			0xA02BFCFF
#define COLOR_PURPLE      	0xB897FFFF // general
#define COLOR_PURPLEL		0xA02BFCFF //INI PURPLE LIGHT
#define COLOR_RADIAL 		0xA02BFC99 //intuk radial 
#define COLOR_PURPLE3 		0xA02BFC99 //intuk radial SAMA AJA
...
#define C_GRAY				0xBABABAFF
#define C_GREEN 			0x3BBD44FF
#define C_YELLOW 			0xFFFF00FF
#define C_RED 				0xFF0000FF
#define C_ORANGE   			0xDB881AF
...
#define COLOR_JUNAI			0x56A4E4FF //dealer

#define FAMILY_E	"{F77AFF}"
#define PURPLE_E2	"{B897FF}"
#define AQUA        "{7fffd4}"
#define RED_E 		"{FF0000}"
