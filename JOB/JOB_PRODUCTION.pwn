...
CMD:sellproduct(playerid, params[])
{
	...
	if(pData[playerid][CarryProduct] == 1)
	{
		...
		Product += 10;
		Server_MinMoney(500);
		Info(playerid, "Anda menjual 10 bahan makanan dengan harga "GREEN_E"$800");
	...
	else if(pData[playerid][CarryProduct] == 2)
	{
		...
		Product += 10;
		Server_MinMoney(500);
		Info(playerid, "Anda menjual 10 product baju dengan harga "GREEN_E"$800");
		pData[playerid][pJobTime] += 480;
	}
	else if(pData[playerid][CarryProduct] == 3)
	{
		...
		Product += 10;
		Server_MinMoney(630);
		Info(playerid, "Anda menjual 10 product equipment dengan harga "GREEN_E"$800");
		pData[playerid][pJobTime] += 480;
	}
	return 1;
}
