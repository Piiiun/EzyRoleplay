...
CMD:createvoucher(playerid, params[])
{
	...
	if(sscanf(params, "dddd", code, vip, viptime, gold)) return SyntaxMsg(playerid, "/createvoucher [CODE(73821)] [VIP] [VIP-TIME(Days)] [GOLD]");
...
{
	new code;
	if(sscanf(params, "d", code)) return SyntaxMsg(playerid, "/voucher [CODE]");
